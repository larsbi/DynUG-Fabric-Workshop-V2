...
There are a few ways to get the M script from the query, either right-click the query and select "Copy" or select "Advanced Editor" in Home or View ribbon and copy the M script
